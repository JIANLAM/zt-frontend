<template>
  <div class="errPage-container">
    ...
    <el-row>
      <el-col :span="12">
        <h1 class="text-jumbo text-ginormous">No permission!</h1>     
        <h2 class="h_title">你没有权限去该页面</h2>
        <h6 class="h_title">如有有问题请联系程序员!</h6>
        <ul class="list-unstyled">
          <li>或者你可以去:</li>
          <li class="link-type">
            <router-link to="/">回首页</router-link>
          </li>
          <li class="link-type"><a href="http://www.baidu.com/">随便看看</a></li>
