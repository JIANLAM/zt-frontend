    ...
    <div id="classification">
        <el-form ref="form" :model="form" label-width="120px">
            ...
            <el-form-item label="馆藏状态">
                <el-select v-model="collStatusIds" style="width: 420px;" multiple>
                    <el-option :label="item.label" :value="item.id" v-for="item in collStateList" :key="item.id"></el-option>
                </el-select>
            </el-form-item>
            ...
            <el-form-item label="索取号范围">
                <el-input v-model="form.callNoStart" style="width: 210px;"></el-input>
                <el-input v-model="form.callNoEnd" style="width: 210px;"></el-input>
            </el-form-item>
...
import {collAddressList,collStateList,circulationList} from '@/request/systemSetup'
import { collectionTypeCount,exportCollection} from '@/request/count'
export default {
    data() {
      return {
        loading:true,
     ...
     methods: {
         ...
         searchData(){
            ...
            this.form.collStatusIds=this.collStatusIds.join(",");
            ...
            this.detail=true;
            this.loading=true;
            collectionTypeCount(this.form).then(data=>{
                if(data.data.code==0){
                    this.data=[]
                    this.loading=false;
