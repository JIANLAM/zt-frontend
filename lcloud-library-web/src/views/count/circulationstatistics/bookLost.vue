        ...
        <el-form ref="form" :model="form" label-width="120px">
            <el-form-item label="统计字段">
                <el-select v-model="form.branch" style="width:420px;">
                    <el-option label="图书流通类型" value="loseCirculLend"></el-option>
                    <el-option label="图书分类" value="loseTypeLend"></el-option>
                    <el-option label="馆藏地点" value="losecollAdsLend"></el-option>
                    <el-option label="读者证类型" value="loseReaderLend"></el-option>
                    <el-option label="学生证 年级" value="loseGradeLend"></el-option>
                    <el-option label="学生证 班级" value="loseClassesLend"></el-option>
                </el-select>
            </el-form-item>
        ...
        searchData(){
          if(this.fieldTemplate.length==0){
            ...
            switch(this.form.branch){
                case "loseCirculLend":this.title="图书流通类型";break;
                case "loseTypeLend":this.title="图书分类";break;
                case "losecollAdsLend":this.title="馆藏地点";break;
                case "loseReaderLend":this.title="读者证类型";break;
                case "loseGradeLend":this.title="学生证 年级";break;
                case "loseClassesLend":this.title="学生证 班级";break;
            }
            this.detail=true;
