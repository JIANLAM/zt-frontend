    ...
    <div>
        ...
        <el-card class="box-card" style="display: none">
            <div slot="header" class="clearfix">
                <span class='title'>馆藏状态设置</span>
                 <el-button type="danger"  style="float:right;margin-left:20px" size="medium" @click="deleteData('more',0)" :disabled="selection0.length==0">删除</el-button>
                <el-button type="primary"  style="float:right" size="medium" @click="add('add',0,'馆藏状态','')">添加</el-button>
            </div>
            <div class="text item">
                <el-table ref="multipleTable" :data="data0" tooltip-effect="dark" style="width: 100%" v-loading='loading' @selection-change="selectChange0">
                    ...
                    <el-table-column prop="value" label="状态代码"></el-table-column>
                    <el-table-column prop="label" label="状态名称"></el-table-column>
                    <el-table-column prop="remarks" label="备注"></el-table-column>
                    <el-table-column label="操作" align="center">
                        <template slot-scope="scope">
                            <el-button type="text" @click="add('modify',0,'馆藏状态',scope.row)">修改</el-button>
      ...
      <!-- 分页 -->
        ...
        <el-card class="box-card">
            <div slot="header" class="clearfix">
                <span class='title'>馆藏地设置</span>
                <span v-for="(item,index) in power" :key="index">
                    <el-button v-if="item.name.trim()=='删除'" type="danger"  style="float:right;margin-left:20px" size="medium" @click="deleteData('more',1)" :disabled="selection1.length==0">删除</el-button>
                    <el-button v-if="item.name.trim()=='新增'" type="primary"  style="float:right" size="medium" @click="add('add',1,'馆藏地','')">添加</el-button>
                </span>
            </div>
            <div class="text item">
                <el-table ref="multipleTable" :data="data1" tooltip-effect="dark" style="width: 100%" v-loading='loading' @selection-change="selectChange1">
                    <el-table-column type="selection" width="55"></el-table-column>
                    <el-table-column type="index" width="55"></el-table-column>
                    <el-table-column prop="value" label="馆藏地代码"></el-table-column>
                    <el-table-column prop="label" label="馆藏地名称"></el-table-column>
                    <el-table-column prop="remarks" label="备注"></el-table-column>
                    <el-table-column label="操作" align="center">
                       <template slot-scope="scope">
                         <span v-for="(item,index) in power" :key="index">
                            <el-button v-if="item.name.trim()=='修改'" type="text" @click="add('modify',1,'馆藏地',scope.row)">修改</el-button>
        ...
        <el-dialog :visible.sync="visible" :title="DialogTitle" class="collectionParameters">
            <el-form ref="form" :model="addForm" label-width="110px" :rules="rules" class="clearfix">
                ...
                <el-form-item class="addSure" label-width="70px">
...
<script>
    ...
    import {collStateList,collStateSave,colleDelete,collAddressList,collAddressSave} from '@/request/systemSetup'
    export default {
        components:{
        },
        data(){
          var checkNumber = (rule, value, callback) => {
            ...
            return {
                ...
                url2:[],
                url:[collStateSave,collAddressSave],
                urlIndex:0,
                content:"",
                code:"",
                name:"",
        ...
        created(){
            ...
            this.getData(collStateList,this.form0,0);
            this.getData(collAddressList,this.form1,1);
            this.getPowerArr();
        },
        methods:{
          //得到权限按钮数组
