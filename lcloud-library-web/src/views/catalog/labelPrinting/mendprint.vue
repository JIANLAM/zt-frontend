 	...
 	<div class="catalong">
      ...
      <span v-if="searchButton">
		    <el-form-item label="条形码">
		        <el-input v-model="searchForm.barcodeStart" clearable @keyup.enter.native="search"></el-input>
		    </el-form-item>
            <el-form-item label="索取号">
                <el-input v-model="searchForm.callNoStart" clearable @keyup.enter.native="search"></el-input>
            </el-form-item>
            <el-form-item  label="打印模板">
                <el-select v-model="searchForm.labelSetId"  placeholder="请选择" :style="{width:'220px'}" @change="processResultFun3(1)">
                    <el-option :label="item.labelName" :value="item.id" v-for="item in labelsetData" :key= item.id ></el-option>
                </el-select>
            </el-form-item>
      </span>
            <el-form-item>
        ...
        <li class="fl"  @click="processResultFun2(1)" :class="{actived:processResultState==1}" v-if="searchButton1"> 打印预览</li>			</ul>
			<div style="padding: 15px;" v-show="processResultState== 0">
...
.printList{display: inline-block;border: 1px solid red;overflow: hidden;box-sizing: border-box}
