<template>
	<div class="container">
		<el-form :inline="true" class="demo-form-inline">
			<el-form-item>
			  <el-button type="success" icon="el-icon-plus" @click="addRule(1)">新增规则</el-button>
			  ...
			  <el-button type="info" icon="iconfont icon-jinyong" :disabled="allSelect">禁用多项</el-button> -->
			   <el-button type="danger" icon="el-icon-delete" :disabled="allSelect" @click="dalet('all','all')">删除</el-button>
		 ...
		 <el-table
		    ...
		    <el-table-column
		     ...
		     <el-table-column
		      ...
		      >
		      	<template slot-scope="scope">
				  <el-button type="text" size="mini" @click="addRule(0,scope.row)">修改</el-button>
				  <el-button type="text" size="mini" :style="{color:'#f56c6c'}" @click="dalet(scope.row,'one')">删除</el-button>
