	...
	<div class="container">
		<el-form :inline="true" :model="searchForm" class="demo-form-inline">
			...
			<el-form-item label="读者证状态">
			    <el-select v-model="searchForm.statusSearch" placeholder="读者证状态">
			...
			<el-form-item label="">
			  <el-button type="success" :icon="more?'el-icon-arrow-up':'el-icon-arrow-down'" @click="more=!more">更多条件</el-button>
			</el-form-item>
			<br/>
			<!-- 更多条件 -->
 		...
 		<el-table
		    ...
		    <el-table-column
		     ...
		     <el-table-column
		      ...
		      >
		      <template slot-scope="scope">
			    	<el-tag :type="scope.row.cardStatus | typeTag" >{{scope.row.cardStatus | typeName}}</el-tag>
		      </template>
		    </el-table-column>
...
import { creditList,readerCreditList,creditUpdate,setstatus,creditMore} from '@/request/lendBuyManage'
  export default{
  	data(){
  		return {
			loading:false,
  	...
  	methods:{
        ...
        creditValue(){
  		...
  		getData(){
  			getData.call(this,creditList,this.form).then(res=>{
